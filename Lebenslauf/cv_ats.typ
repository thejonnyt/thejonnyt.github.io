...
#section("Professional Experience")
  ...
  technologies: ("Docker", "Docker Compose", "Python", "Bash", "SpaCy", "pytest", "FastAPI", "gRPC", "Protocol Buffers", "JavaScript", "TypeScript", "Next.js", "React", "Qdrant", "RAG", "MongoDB", "MariaDB", "SQL", "LLMs", "NLP/ML", "nginx", "Linux", "CI/CD", "GitHub", "Docker Hub", "git"),
)
...
#skills-section((
  ...
  ("Tools & Systems", ("git", "Linux", "Excel", "PowerPoint", "MS Office", "MS Teams", "Miro", "Business Model Canvas", "Lean Startup", "VSCode", LaTeX, "pytest", "Protocol Buffers", "GitHub", "Docker Hub", "gcode", "Markdown",)),
))
