...
#skills-section((
  ("Analysis, ML & AI", ("LLMs", "NLP", "Machine Learning", "SPSS", "Statistics", "SpaCy", "RAG", "Algebra", "Decision Trees", "Random Forests", "PyTorch", "Convolutional Neural Networks",)),
  ("Backend & DevOps", ("Docker", "gRPC", "MongoDB", "MariaDB", "PostgreSQL", "nginx", "CI/CD", "FastAPI", "Protocol Buffers", "Docker Hub",)),
  ("Programming Languages", ("Java", "Python", "JavaScript", "TypeScript", "R", "Bash", "SQL", "noSQL", "Qdrant",)),
  ("Tools & Systems", ("git", "Linux", "Excel", "PowerPoint", "MS Office", "MS Teams", "Miro", "Business Model Canvas", "Lean Startup", "VSCode", LaTeX, "pytest", "GitHub", "gcode", "STL", "Markdown",)),
