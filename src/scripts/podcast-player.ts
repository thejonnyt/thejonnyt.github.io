...
function initPodcastWhenVisible() {
  const wrapper = document.querySelector('.podcast-player-wrapper') as HTMLElement | null;
...
if (document.readyState === 'loading') {
  document.addEventListener('DOMContentLoaded', initPodcastWhenVisible, { once: true });
} else {
  initPodcastWhenVisible();
}

document.addEventListener('astro:after-swap', initPodcastWhenVisible);
